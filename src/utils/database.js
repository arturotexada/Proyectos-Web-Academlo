...
const db = new Sequelize({
    ...
    database: process.env.DB_NAME, //"users_crud_775s",
    port: process.env.DB_PORT, //5432,
    username: process.env.DB_USERNAME, //'arturoxts',
    password: process.env.DB_PASSWORD, //'pS2KgX4pq0BrP5GWFqdil1PDZCoW9fRP',
    dialect: 'postgres',
